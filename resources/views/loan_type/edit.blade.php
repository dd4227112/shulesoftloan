{{Form::model($loanType, array('route' => array('loan-type.update', $loanType->id), 'method' => 'PUT')) }}
<div class="modal-body">
    <div class="row">
        ...
        <div class="form-group col-md-6 col-lg-6">
            ...
            {!! Form::select('loan_term_period', $termPeroid, null,array('class' => 'form-control hidesearch','required'=>'required')) !!}
        </div>
        <div class="form-group  col-md-6 col-lg-6">
        ...
        <div class="form-group col-md-6 col-lg-6">
            ...
            {!! Form::select('interest_type', $interestType, null,array('class' => 'form-control hidesearch','required'=>'required')) !!}
        </div>
        <div class="form-group  col-md-6 col-lg-6">
