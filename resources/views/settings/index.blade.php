                                ...
                                @if (Gate::check('manage account settings'))
                                    <div class="tab-pane {{ empty($activeTab) || $activeTab == 'user_profile_settings' ? ' active show ' : '' }}"
                                        ...
                                        <div class="d-flex align-items-center mb-3">
                                            <div class="flex-shrink-0">
                                                @if($user->profile)
                                                    {{-- <img src="{{ asset('storage/profile/' . $user->profile) }}" class="user-profile" alt="Profile"> --}}
                                                    <img src="{{ asset('storage/upload/profile/' . $user->profile) }}" alt="Profile" class="user-profile">
                                                @else
                                                    <img src="{{ asset('assets/images/default-avatar.png') }}" class="user-profile" alt="Default Profile">
                                                @endif
                                            </div>
                                        </div>
                                        <div class="row">
