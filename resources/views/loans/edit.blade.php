...
@section('content')
    <div class="row">
        {{ Form::model($loan, ['route' => ['loan.update', $loan->id], 'method' => 'PUT', 'enctype' => 'multipart/form-data']) }}
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="form-group col-md-4 col-lg-4">
                            ...
                            {{ Form::textarea('notes', null, ['class' => 'form-control', 'rows' => '1', 'placeholder' => __('Enter notes'), 'required' => 'required']) }}
                        </div>
                    </div>
                </div>
            </div>
