                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="form-group col-md-4 col-lg-4">
                            ...
                            {{ Form::date('loan_start_date', old('loan_start_date'), ['class' => 'form-control', 'placeholder' => __('Enter loan start date'), 'required' => 'required']) }}
                        </div>
                        <div class="form-group col-md-4 col-lg-4">
                            {{ Form::label('loan_due_date', __('loan due date'), ['class' => 'form-label']) }}
                            {{ Form::date('loan_due_date', old('loan_due_date'), ['class' => 'form-control', 'placeholder' => __('Enter loan due date'), 'required' => 'required']) }}
                        </div>
                        <div class="form-group col-md-4 col-lg-4">
                        ...
                        <div class="form-group col-md-4 col-lg-4">
                            ...
                            {{ Form::number('loan_terms', old('loan_terms'), ['class' => 'form-control', 'step' => 0.1, 'placeholder' => __('Enter loan terms'), 'required' => 'required']) }}
                        </div>
                        <div class="form-group col-md-4 col-lg-4">
                ...
                <div class="card-body">
                    <div class="row document_list">
                        ...
                        <div class="col-auto m-auto">
                            <a href="javascript:void(0)" class="text-danger location_list_remove btn btn-md document_list_remove "> <i
