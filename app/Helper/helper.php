                        ...
                        <div class="row align-items-center justify-content-between">
                            <div class="col-lg-5 col-xl-4">
                                <h1 class="mt-sm-3 mb-sm-4 f-w-600 wow fadeInUp" data-wow-delay="0.2s">
                                    ...
                                    <span class="text-primary">Berry</span>
                                </h1>
                                <h4 class="mb-sm-4 text-muted wow fadeInUp" data-wow-delay="0.4s">
                                    Berry is React based admin template which helps you to build faster and beautiful web
                                    applications.
                                </h4>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-4 wow fadeInUp" data-wow-delay="0.2s">
                                ...
                                <h4 class="my-3 text-white">About Berry</h4>
                                <p class="mb-4 text-white text-opacity-75">
                                    Berry React is a dashboard template that utilizes the Material-UI framework and the React
